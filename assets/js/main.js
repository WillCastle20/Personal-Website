...
// Scroll function for Leadership section
function scrollLeadership(direction) {
  const panel = document.querySelector('.panel.color3');
  const amount = 1000; // pixels to scroll per click
